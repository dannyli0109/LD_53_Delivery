/** [window.p5.sound]  Version: 1.0.1 - 2021-06-11 */ 
 /**
 *  <p>window.p5.sound extends p5 with <a href="http://caniuse.com/audio-api"
 *  target="_blank">Web Audio</a> functionality including audio input,
 *  playback, analysis and synthesis.
 *  </p>
 *  <ul>
 *  <li><a href="#/window.p5.SoundFile"><b>window.p5.SoundFile</b></a>: Load and play sound files.</li>
 *  <li><a href="#/window.p5.Amplitude"><b>window.p5.Amplitude</b></a>: Get the current volume of a sound.</li>
 *  <li><a href="#/window.p5.AudioIn"><b>window.p5.AudioIn</b></a>: Get sound from an input source, typically
 *    a computer microphone.</li>
 *  <li><a href="#/window.p5.FFT"><b>window.p5.FFT</b></a>: Analyze the frequency of sound. Returns
 *    results from the frequency spectrum or time domain (waveform).</li>
 *  <li><a href="#/window.p5.Oscillator"><b>window.p5.Oscillator</b></a>: Generate Sine,
 *    Triangle, Square and Sawtooth waveforms. Base class of
 *    <li><a href="#/window.p5.Noise">window.p5.Noise</a> and <a href="#/window.p5.Pulse">window.p5.Pulse</a>.
 *    </li>
 *  <li>
 *    <a href="#/window.p5.MonoSynth">window.p5.MonoSynth</a> and <a href="#/window.p5.PolySynth">window.p5.PolySynth</a>: Play musical notes
 *  </li>
 *  <li><a href="#/window.p5.Envelope"><b>window.p5.Envelope</b></a>: An Envelope is a series
 *    of fades over time. Often used to control an object's
 *    output gain level as an "ADSR Envelope" (Attack, Decay,
 *    Sustain, Release). Can also modulate other parameters.</li>
 *  <li><a href="#/window.p5.Delay"><b>window.p5.Delay</b></a>: A delay effect with
 *    parameters for feedback, delayTime, and lowpass filter.</li>
 *  <li><a href="#/window.p5.Filter"><b>window.p5.Filter</b></a>: Filter the frequency range of a
 *    sound.
 *  </li>
 *  <li><a href="#/window.p5.Reverb"><b>window.p5.Reverb</b></a>: Add reverb to a sound by specifying
 *    duration and decay. </li>
 *  <b><li><a href="#/window.p5.Convolver">window.p5.Convolver</a>:</b> Extends
 *  <a href="#/window.p5.Reverb">window.p5.Reverb</a> to simulate the sound of real
 *    physical spaces through convolution.</li>
 *  <b><li><a href="#/window.p5.SoundRecorder">window.p5.SoundRecorder</a></b>: Record sound for playback
 *    / save the .wav file.
 *  <b><li><a href="#/window.p5.SoundLoop">window.p5.SoundLoop</a>, <a href="#/window.p5.Phrase">window.p5.Phrase</a></b>, <b><a href="#/window.p5.Part">window.p5.Part</a></b> and
 *  <b><a href="#/window.p5.Score">window.p5.Score</a></b>: Compose musical sequences.
 *  </li>
 *  <li><a href="#/p5/userStartAudio">userStartAudio</a>: Enable audio in a
 *  browser- and user-friendly way.</a>
 *  <p>window.p5.sound is on <a href="https://github.com/processing/window.p5.js-sound/">GitHub</a>.
 *  Download the latest version
 *  <a href="https://github.com/processing/window.p5.js-sound/blob/master/lib/window.p5.sound.js">here</a>.</p>
 *
 *  @module window.p5.sound
 *  @submodule window.p5.sound
 *  @for window.p5.sound
 *  @main
 */
...
/**
 *  window.p5.sound 
 *  https://p5js.org/reference/#/libraries/window.p5.sound
 *
 *  From the Processing Foundation and contributors
 *  https://github.com/processing/window.p5.js-sound/graphs/contributors
 *
 *  MIT License (MIT)
 *  https://github.com/processing/window.p5.js-sound/blob/master/LICENSE
 *
 *  Some of the many audio libraries & resources that inspire window.p5.sound:
...
var audiocontext = new window.AudioContext(); // Tone and window.p5.sound share the same audio context
 ...
 *    }
 *    var synth = new window.p5.MonoSynth();
 ...
 *  calling <code>start()</code> on a <code>window.p5.Oscillator</code>,
 *  <code> play()</code> on a <code>window.p5.SoundFile</code>, or simply
 ...
 *                                Selector String, NodeList, window.p5.Element,
 ...
 *
 *    let mySynth = new window.p5.MonoSynth();
 *
...
function userStartAudio(elements, callback) {
  ...
  if (elements instanceof window.p5.Element) {
    elt = elements.elt;
  } else if (elements instanceof Array && elements[0] instanceof window.p5.Element) {
...
// Polyfill for AudioIn, also handled by window.p5.dom createCapture
...
window.p5.prototype.isSupported = function () {
...
window.p5.prototype.isFileSupported = function (extension) {
...
window.p5.prototype.getOutputVolume = function () {
 ...
 *
 *  <p><b>How This Works</b>: When you load the window.p5.sound module, it
...
window.p5.prototype.outputVolume = function (vol) {
...
/**
 *  `window.p5.soundOut` is the window.p5.sound final output bus. It sends output to
...
window.p5.prototype.soundOut = window.p5.soundOut = p5sound; // a silent connection to the DesinationNode
// which will ensure that anything connected to it
// will not be garbage collected

window.p5.soundOut._silentNode = p5sound.audiocontext.createGain();
window.p5.soundOut._silentNode.gain.value = 0;

window.p5.soundOut._silentNode.connect(p5sound.audiocontext.destination);
...
function _checkFileFormats(paths) {
  ...
  if (typeof paths === 'string') {
    ...
    if (['mp3', 'wav', 'ogg', 'm4a', 'aac'].indexOf(extTest) > -1) {
      if (!window.p5.prototype.isFileSupported(extTest)) {
        ...
        for (var _i = 0; _i < main.extensions.length; _i++) {
          ...
          var _supported = window.p5.prototype.isFileSupported(_extension);
        ...
        for (var _i3 = 0; _i3 < main.extensions.length; _i3++) {
          ...
          var _supported2 = window.p5.prototype.isFileSupported(_extension2);
  ...
  // path can either be a single string, or an array
      ...
      for (var i = 0; i < paths.length; i++) {
        ...
        var supported = window.p5.prototype.isFileSupported(extension);
...
/**
 * Save a window.p5.SoundFile as a .wav file. The browser will prompt the user
 * to download the file to their device.
 * For uploading audio to a server, use
 * <a href="/docs/reference/#/window.p5.SoundFile/saveBlob">`window.p5.SoundFile.saveBlob`</a>.
 *
 *  @for p5
 *  @method saveSound
 *  @param  {window.p5.SoundFile} soundFile window.p5.SoundFile that you wish to save
 *  @param  {String} fileName      Name of the resulting .wav file.
 */
// add to window.p5.prototype as this is used by the p5 `save()` method.


function saveSound(soundFile, fileName) {
  var dataView = convertToWav(soundFile.buffer);
  window.p5.prototype.writeFile([dataView], fileName, 'wav');
}
...
/*
    ...
    @property {String} stack trace the error back to a line in the user's sketch.
                             Note: this edits out stack trace within window.p5.js and window.p5.sound.
...
var CustomError = function CustomError(name, errorTrace, failedPath) {
  ...
  splitStack = tempStack.split('\n').filter(function (ln) {
    return !ln.match(/(window.p5.|native code|globalInit)/g);
  });
...
window.p5.prototype.registerMethod('init', function () {
 ...
 *
 *  <p>The window.p5.SoundFile may not be available immediately because
 ...
 *
 *  @class window.p5.SoundFile
 *  @constructor
 *  @param {String|Array} path   Path to a sound file (String). Optionally,
 *                               you may include multiple file formats in
 *                               an array. Alternately, accepts an object
 *                               from the HTML5 File API, or a window.p5.File.
...
function () {
  function SoundFile(paths, onload, onerror, whileLoading) {
    ...
    if (typeof paths !== 'undefined') {
      if (typeof paths === 'string' || typeof paths[0] === 'string') {
        var path = window.p5.prototype._checkFileFormats(paths);
      ...
      } // if type is a window.p5.File...get the actual file
    ...
    } // add this window.p5.SoundFile to the soundArray
  ...
  /**
   * This is a helper function that the window.p5.SoundFile calls to load
   * itself. Accepts a callback (the name of another function)
   * as an optional parameter.
   *
   * @private
   * @for window.p5.SoundFile
   * @param {Function} [successCallback]   Name of a function to call once file loads
  ...
  soundfile_createClass(SoundFile, [{
    ...
    /**
     * Play the window.p5.SoundFile
     *
     * @method play
     * @for window.p5.SoundFile
     * @param {Number} [startTime]            Schedule playback to start (in seconds from now) (Optional).
     * @param {Number} [rate]             Playback rate (Optional)
     * @param {Number} [amp]              Amplitude (volume) (Optional)
     *                                     of playback
     * @param {Number} [cueStart]        Cue start time in seconds (Optional)
     * @param {Number} [duration]          Duration of playback in seconds (Optional)
     */
    ...
    /**
     *  window.p5.SoundFile has two play modes: <code>restart</code> and
     *  <code>sustain</code>. Play Mode determines what happens to a
     *  window.p5.SoundFile if it is triggered while in the middle of playback.
     ...
     *  position.
     *  If window.p5.SoundFile had been set to loop before it was paused,
     *  it will continue to loop after it is unpaused with .play().
     *
     *  @method pause
     *  @for window.p5.SoundFile
     *  @param {Number} [startTime] Schedule event to occur
     *                               seconds from now (Optional)
     *  @example
     *  <div><code>
     *  let soundFile;
     *  function preload() {
    ...
    /**
     * Loop the window.p5.SoundFile. Accepts optional parameters to set the
     ...
     *                             seconds from now (Optional)
     * @param {Number} [rate]        Playback rate (Optional)
     * @param {Number} [amp]         Playback volume (Optional)
     * @param {Number} [cueLoopStart] StartTime in seconds (Optional)
     * @param {Number} [duration]  Loop duration in seconds (Optional)
     * @example
     *  <div><code>
     *  let soundFile;
     *  let loopStart = 0.5;
    ...
    /**
     * Set a window.p5.SoundFile's looping flag to true or false. If the sound
    ...
    /**
     * Returns 'true' if a window.p5.SoundFile is currently looping and playing, 'false' if not.
     *
     * @method isLooping
     * @for window.p5.SoundFile
     * @return {Boolean}
    ...
    /**
     *  Returns true if a window.p5.SoundFile is playing, false if not (i.e.
     *  paused or stopped).
     *
     *  @method isPlaying
     *  @for window.p5.SoundFile
    ...
    /**
     *  Returns true if a window.p5.SoundFile is paused, false if not (i.e.
     *  playing or stopped).
     *
     *  @method  isPaused
     *  @for window.p5.SoundFile
    ...
    /**
     * Set the stereo panning of a window.p5.sound object to
    ...
    /**
     * Return the current position of the window.p5.SoundFile playhead, in seconds.
     * Time is relative to the normal buffer direction, so if `reverseBuffer`
     * has been called, currentTime will count backwards.
     *
     * @method currentTime
     * @for window.p5.SoundFile
     * @return {Number}   Current time of the soundFile in seconds.
     */
    ...
    /**
     * Returns an array of amplitude peaks in a window.p5.SoundFile that can be
     * used to draw a static waveform. Scans through the window.p5.SoundFile's
    ...
    /**
     *  Reverses the window.p5.SoundFile's buffer source.
     ...
     * window.p5.sound object. For example, you may connect a window.p5.SoundFile to an
    ...
    value: function getLevel() {
      console.warn('window.p5.SoundFile.getLevel has been removed from the library. Use window.p5.Amplitude instead');
    }
    /**
    ...
    value: function setPath(p, callback) {
      var path = window.p5.prototype._checkFileFormats(p);
    ...
    value: function _initCounterNode() {
      ...
      self._workletNode.connect(window.p5.soundOut._silentNode);
     ...
     * <a href="/reference/#/window.p5.SoundFile/getBlob">getBlob</a>
     *
     * @method save
     * @for window.p5.SoundFile
     * @param  {String} [fileName]      Name of the resulting .wav file.
    ...
    value: function save(fileName) {
      window.p5.prototype.saveSound(this, fileName, 'wav');
    }
    /**
...
/**
 *  loadSound() returns a new window.p5.SoundFile from a specified
 *  path. If called during preload(), the window.p5.SoundFile will be ready
 *  to play in time for setup() and draw(). If called outside of
 *  preload, the window.p5.SoundFile will not be ready immediately, so
 *  loadSound accepts a callback as the second parameter. Using a
 *  <a href="https://github.com/processing/window.p5.js/wiki/Local-server">
 ...
 *  @return {SoundFile}            Returns a window.p5.SoundFile
 *  @example
 *  <div><code>
 *  let mySound;
 *  function preload() {
...
function () {
  function Amplitude(smoothing) {
    ...
    main.meter.connect(this._workletNode); // add this window.p5.SoundFile to the soundArray
 ...
 *
 *  <p>Once instantiated, a window.p5.FFT object can return an array based on
...
function () {
  function FFT(smoothing, bins) {
    ...
    this.treble = [5200, 14000]; // add this window.p5.SoundFile to the soundArray
   ...
   *  @method  setInput
   *  @for window.p5.FFT
   *  @param {Object} [source] window.p5.sound object (or web audio API source node)
   */
  ...
  fft_createClass(FFT, [{
    ...
    value: function waveform() {
      ...
      if (mode && !window.p5.prototype._isSafari()) {
        ...
        for (var j = 0; j < this.timeDomain.length; j++) {
          var scaled = window.p5.prototype.map(this.timeDomain[j], 0, 255, -1, 1);
 ...
 *  specific oscillator: <a href="/reference/#/window.p5.SinOsc">window.p5.SinOsc</a>, <a
 *  href="/reference/#/window.p5.TriOsc">window.p5.TriOsc</a>, <a
 *  href="/reference/#/window.p5.SqrOsc">window.p5.SqrOsc</a>, or <a
 *  href="/reference/#/window.p5.SawOsc">window.p5.SawOsc</a>.
 *  </p>
 *
 *  @class window.p5.Oscillator
 *  @constructor
 ...
 *    osc = new window.p5.Oscillator('sine');
 *  }
 *
 *  function draw() {
 *    background(220)
...
function () {
  ...
  oscillator_createClass(Oscillator, [{
     ...
     *    let cnv = createCanvas(100, 100);
     *    cnv.mousePressed(playOscillator);
     *    osc = new window.p5.Oscillator(300);
     *    background(220);
     *    text('tap to play', 20, 20);
     *  }
     *
    ...
    /**
     *  Connect to a window.p5.sound / Web Audio object.
     *
     *  @method  connect
     *  @for window.p5.Oscillator
     *  @param  {Object} unit A window.p5.sound or Web Audio object
     */
    ...
    /**
     *  Returns the current value of panPosition, a value between Left (-1) and Right (1)
     *
     *  @method  getPan
     *  @for window.p5.Oscillator
     *
     *  @returns {number} Pan position of oscillator, a value between Left (-1) and Right (1)
     */
    ...
    value: function phase(p) {
      var delayAmt = window.p5.prototype.map(p, 0, 1.0, 0, 1 / this.f);
      var now = main.audiocontext.currentTime;
      this.phaseAmount = p;
    ...
    /**
     *  Add a value to the window.p5.Oscillator's output amplitude,
     ...
     *  @return {window.p5.Oscillator} Returns this oscillator
     *                                     with scaled output
     *
     */
    ...
    /**
     *  Multiply the window.p5.Oscillator's output amplitude
    ...
    value: function scale(inMin, inMax, outMin, outMax) {
      ...
      if (arguments.length === 4) {
        mapOutMin = window.p5.prototype.map(outMin, inMin, inMax, 0, 1) - 0.5; //find a way to get rid of window.p5.prototype ?

        mapOutMax = window.p5.prototype.map(outMax, inMin, inMax, 0, 1) - 0.5; //find a way to get rid of window.p5.prototype ?
      } else {
...
/**
 *  Constructor: <code>new window.p5.SinOsc()</code>.
 *  This creates a Sine Wave Oscillator and is
 *  equivalent to <code> new window.p5.Oscillator('sine')
 *  </code> or creating a window.p5.Oscillator and then calling
 *  its method <code>setType('sine')</code>.
 *  See window.p5.Oscillator for methods.
 *
 *  @class  window.p5.SinOsc
 *  @constructor
 *  @extends window.p5.Oscillator
...
/**
 *  Constructor: <code>new window.p5.TriOsc()</code>.
 *  This creates a Triangle Wave Oscillator and is
 *  equivalent to <code>new window.p5.Oscillator('triangle')
 *  </code> or creating a window.p5.Oscillator and then calling
 *  its method <code>setType('triangle')</code>.
 *  See window.p5.Oscillator for methods.
 *
 *  @class  window.p5.TriOsc
 *  @constructor
 *  @extends window.p5.Oscillator
 *  @param {Number} [freq] Set the frequency
 */
...
/**
 *  Constructor: <code>new window.p5.SawOsc()</code>.
 *  This creates a SawTooth Wave Oscillator and is
 *  equivalent to <code> new window.p5.Oscillator('sawtooth')
 *  </code> or creating a window.p5.Oscillator and then calling
 *  its method <code>setType('sawtooth')</code>.
 *  See window.p5.Oscillator for methods.
 *
 *  @class  window.p5.SawOsc
 *  @constructor
 *  @extends window.p5.Oscillator
 *  @param {Number} [freq] Set the frequency
 */
...
/**
 *  Constructor: <code>new window.p5.SqrOsc()</code>.
 *  This creates a Square Wave Oscillator and is
 *  equivalent to <code> new window.p5.Oscillator('square')
 *  </code> or creating a window.p5.Oscillator and then calling
 *  its method <code>setType('square')</code>.
 *  See window.p5.Oscillator for methods.
 *
 *  @class  window.p5.SqrOsc
 *  @constructor
 *  @extends window.p5.Oscillator
 *  @param {Number} [freq] Set the frequency
 */
 ...
 *  ). Envelopes can also control other Web Audio Parameters—for example, a window.p5.Envelope can
 *  control an Oscillator's frequency like this: <code>osc.freq(env)</code>.</p>
 *  <p>Use <code><a href="#/window.p5.Envelope/setRange">setRange</a></code> to change the attack/release level.
 *  Use <code><a href="#/window.p5.Envelope/setADSR">setADSR</a></code> to change attackTime, decayTime, sustainPercent and releaseTime.</p>
 *  <p>Use the <code><a href="#/window.p5.Envelope/play">play</a></code> method to play the entire envelope,
 *  the <code><a href="#/window.p5.Envelope/ramp">ramp</a></code> method for a pingable trigger,
 *  or <code><a href="#/window.p5.Envelope/triggerAttack">triggerAttack</a></code>/
 *  <code><a href="#/window.p5.Envelope/triggerRelease">triggerRelease</a></code> to trigger noteOn/noteOff.</p>
 *
 *  @class window.p5.Envelope
 *  @constructor
 *  @example
 *  <div><code>
 ...
 *
 *    env = new window.p5.Envelope(t1, l1, t2, l2);
 *    triOsc = new window.p5.Oscillator('triangle');
 *  }
 *
 *  function playSound() {
...
window.p5.Envelope = function (t1, l1, t2, l2, t3, l3) {
  /**
...
window.p5.Envelope.prototype._init = function () {
  var now = main.audiocontext.currentTime;
  var t = now;
...
window.p5.Envelope.prototype.set = function (t1, l1, t2, l2, t3, l3) {
  this.aTime = t1;
  this.aLevel = l1;
  this.dTime = t2 || 0;
  this.dLevel = l2 || 0;
...
window.p5.Envelope.prototype.setADSR = function (aTime, dTime, sPercent, rTime) {
  this.aTime = aTime;
...
window.p5.Envelope.prototype.setRange = function (aLevel, rLevel) {
...
window.p5.Envelope.prototype._setRampAD = function (t1, t2) {
...
window.p5.Envelope.prototype.setRampPercentages = function (p1, p2) {
 ...
 *  If a window.p5.Sound object is given, then the window.p5.Envelope will control its
 *  output gain. If multiple inputs are provided, the env will
 *  control all of them.
 *
 *  @method  setInput
 *  @for window.p5.Envelope
 *  @param  {Object} [...inputs]         A window.p5.sound object or
 *                                Web Audio Param.
 */


window.p5.Envelope.prototype.setInput = function () {
  for (var i = 0; i < arguments.length; i++) {
...
window.p5.Envelope.prototype.setExp = function (isExp) {
  this.isExponential = isExp;
}; //helper method to protect against zero values being sent to exponential functions


window.p5.Envelope.prototype.checkExpInput = function (value) {
  if (value <= 0) {
    value = 0.00000001;
  }
 ...
 *  If the input is a window.p5.sound object (i.e. AudioIn, Oscillator,
 ...
 *  @method  play
 *  @for window.p5.Envelope
 *  @param  {Object} unit         A window.p5.sound object or
 *                                Web Audio Param.
...
window.p5.Envelope.prototype.play = function (unit, secondsFromNow, susTime) {
 ...
 *  any window.p5.sound object, or a <a href="
 *  http://docs.webplatform.org/wiki/apis/webaudio/AudioParam">
 *  Web Audio Param</a>.
 *
 *  @method  triggerAttack
 *  @for window.p5.Envelope
 *  @param  {Object} unit window.p5.sound Object or Web Audio Param
...
window.p5.Envelope.prototype.triggerAttack = function (unit, secondsFromNow) {
  var now = main.audiocontext.currentTime;
  var tFromNow = secondsFromNow || 0;
  var t = now + tFromNow;
  this.lastAttack = t;
...
window.p5.Envelope.prototype.triggerRelease = function (unit, secondsFromNow) {
 ...
 *  values from <code><a href="#/window.p5.Envelope/setADSR">setADSR(attackTime, decayTime)</a></code>
...
window.p5.Envelope.prototype.ramp = function (unit, secondsFromNow, v1, v2) {
  var now = main.audiocontext.currentTime;
  var tFromNow = secondsFromNow || 0;
  var t = now + tFromNow;
...
window.p5.Envelope.prototype.connect = function (unit) {
  this.connection = unit; // assume we're talking about output gain
  // unless given a different audio param

  if (unit instanceof window.p5.Oscillator || unit instanceof window.p5.SoundFile || unit instanceof window.p5.AudioIn || unit instanceof window.p5.Reverb || unit instanceof window.p5.Noise || unit instanceof window.p5.Filter || unit instanceof window.p5.Delay) {
...
window.p5.Envelope.prototype.disconnect = function () {
  if (this.output) {
    this.output.disconnect();
  }
}; // Signal Math
 ...
 *  @for window.p5.Envelope
 *  @param {Number} number Constant number to add
 *  @return {window.p5.Envelope} Envelope Returns this envelope
 *                                     with scaled output
 */


window.p5.Envelope.prototype.add = function (num) {
  var add = new Add_default.a(num);
  var thisChain = this.mathOps.length;
  var nextChain = this.output;
  return window.p5.prototype._mathChain(this, add, thisChain, nextChain, Add_default.a);
};
/**
 *  Multiply the window.p5.Envelope's output amplitude
...
window.p5.Envelope.prototype.mult = function (num) {
  var mult = new Multiply_default.a(num);
  var thisChain = this.mathOps.length;
  var nextChain = this.output;
  return window.p5.prototype._mathChain(this, mult, thisChain, nextChain, Multiply_default.a);
};
/**
 ...
 *  @for window.p5.Envelope
 *  @param  {Number} inMin  Input range minumum
 *  @param  {Number} inMax  Iput range maximum
 *  @param  {Number} outMin Input range minumum
 *  @param  {Number} outMax Input range maximum
 *  @return {window.p5.Envelope}  Returns this envelope
 *                                     with scaled output
 */


window.p5.Envelope.prototype.scale = function (inMin, inMax, outMin, outMax) {
  var scale = new Scale_default.a(inMin, inMax, outMin, outMax);
  var thisChain = this.mathOps.length;
  var nextChain = this.output;
  return window.p5.prototype._mathChain(this, scale, thisChain, nextChain, Scale_default.a);
}; // get rid of the oscillator


window.p5.Envelope.prototype.dispose = function () {
  // remove reference from soundArray
  var index = main.soundArray.indexOf(this);
  main.soundArray.splice(index, 1);
  this.disconnect();
...
}; // Different name for backwards compatibility, replicates window.p5.Envelope class


window.p5.Env = function (t1, l1, t2, l2, t3, l3) {
  console.warn('WARNING: window.p5.Env is now deprecated and may be removed in future versions. ' + 'Please use the new window.p5.Envelope instead.');
  window.p5.Envelope.call(this, t1, l1, t2, l2, t3, l3);
};

window.p5.Env.prototype = Object.create(window.p5.Envelope.prototype);
var Envelope = window.p5.Envelope;
 ...
 *  http://p5js.org/reference/#/window.p5.Oscillator">
 *  <code>window.p5.Oscillator</code> for a full list of methods.
 *
 *  @class window.p5.Pulse
 *  @extends window.p5.Oscillator
 *  @constructor
 ...
 *  AudioIn does not connect to window.p5.sound output by default to prevent
 *  feedback.</p>
 *
...
function () {
  function AudioIn(errorCallback) {
     ...
     *
     *  @property {window.p5.Amplitude} amplitude
     */
   ...
   *  is not connected to window.p5.sound's output. So you won't hear
...
/**
 * Effect is a base class for audio effects in window.p5. <br>
 * This module handles the nodes and methods that are
 * common and useful for current and future effects.
 *
 *
 * This class is extended by <a href="/reference/#/window.p5.Distortion">window.p5.Distortion</a>,
 * <a href="/reference/#/window.p5.Compressor">window.p5.Compressor</a>,
 * <a href="/reference/#/window.p5.Delay">window.p5.Delay</a>,
 * <a href="/reference/#/window.p5.Filter">window.p5.Filter</a>,
 * <a href="/reference/#/window.p5.Reverb">window.p5.Reverb</a>.
 *
 * @class  window.p5.Effect
 * @constructor
 *
...
function () {
  function Effect() {
    ...
    /**
     *	The window.p5.Effect class is built
     ...
     *	window.p5.Effect, connect effect nodes
  ...
  effect_createClass(Effect, [{
    ...
    /**
     *  Send output to a window.p5.js-sound, Web Audio Node, or use signal to
    ...
    key: "connect",
    value: function connect(unit) {
      var u = unit || window.p5.soundOut.input;
...
/**
 *  <p>A window.p5.Filter uses a Web Audio Biquad Filter to filter
 *  the frequency response of an input source. Subclasses
 *  include:</p>
 *  <a href="/reference/#/window.p5.LowPass"><code>window.p5.LowPass</code></a>:
 *  Allows frequencies below the cutoff frequency to pass through,
 *  and attenuates frequencies above the cutoff.<br/>
 *  <a href="/reference/#/window.p5.HighPass"><code>window.p5.HighPass</code></a>:
 *  The opposite of a lowpass filter. <br/>
 *  <a href="/reference/#/window.p5.BandPass"><code>window.p5.BandPass</code></a>:
 ...
 *
 *  This class extends <a href = "/reference/#/window.p5.Effect">window.p5.Effect</a>.
 *  Methods <a href = "/reference/#/window.p5.Effect/amp">amp()</a>, <a href = "/reference/#/window.p5.Effect/chain">chain()</a>,
 *  <a href = "/reference/#/window.p5.Effect/drywet">drywet()</a>, <a href = "/reference/#/window.p5.Effect/connect">connect()</a>, and
 *  <a href = "/reference/#/window.p5.Effect/disconnect">disconnect()</a> are available.
 *
 *  @class window.p5.Filter
 *  @extends window.p5.Effect
 *  @constructor
 ...
 *    fill(255, 0, 255);
 *
 *    filter = new window.p5.BandPass();
 *    noise = new window.p5.Noise();
 *    noise.disconnect();
...
function (_Effect) {
  ...
  function Filter(type) {
    ...
    /**
     *  The window.p5.Filter is built with a
  ...
  filter_createClass(Filter, [{
     ...
     *  @param {Number} [timeFromNow] Schedule this event to happen
     *                                seconds from now
     *  @return {Number}   Returns the current frequency value
     */
     ...
     * This is distinctly different from .amp() which is inherited from window.p5.Effect
     * .amp() controls the volume via the output gain node
     * window.p5.Filter.gain() controls the gain parameter of a Biquad Filter node.
     *
     * @method gain
     * @param  {Number} gain
    ...
    /**
     *  Set the type of a window.p5.Filter. Possible types include:
...
/**
 *  Constructor: <code>new window.p5.LowPass()</code> Filter.
 *  This is the same as creating a window.p5.Filter and then calling
 *  its method <code>setType('lowpass')</code>.
 *  See window.p5.Filter for methods.
 *
 *  @class window.p5.LowPass
 *  @constructor
 *  @extends window.p5.Filter
 */
...
/**
 *  Constructor: <code>new window.p5.HighPass()</code> Filter.
 *  This is the same as creating a window.p5.Filter and then calling
 *  its method <code>setType('highpass')</code>.
 *  See window.p5.Filter for methods.
 *
 *  @class window.p5.HighPass
 *  @constructor
 *  @extends window.p5.Filter
 */
...
/**
 *  Constructor: <code>new window.p5.BandPass()</code> Filter.
 *  This is the same as creating a window.p5.Filter and then calling
 *  its method <code>setType('bandpass')</code>.
 *  See window.p5.Filter for methods.
 *
 *  @class window.p5.BandPass
 *  @constructor
 *  @extends window.p5.Filter
 */
...
/**
 *  EQFilter extends window.p5.Filter with constraints
 *  necessary for the window.p5.EQ
 *
 *  @private
 */
...
function (_Filter) {
  ...
  eqFilter_createClass(EQFilter, [{
    key: "amp",
    value: function amp() {
      console.warn('`amp()` is not available for window.p5.EQ bands. Use `.gain()`');
    }
  }, {
    key: "drywet",
    value: function drywet() {
      console.warn('`drywet()` is not available for window.p5.EQ bands.');
    }
  }, {
    key: "connect",
    value: function connect(unit) {
...
/**
 * window.p5.EQ is an audio effect that performs the function of a multiband
 * audio equalizer. Equalization is used to adjust the balance of
 * frequency compoenents of an audio signal. This process is commonly used
 * in sound production and recording to change the waveform before it reaches
 * a sound output device. EQ can also be used as an audio effect to create
 * interesting distortions by filtering out parts of the spectrum. window.p5.EQ is
 * built using a chain of Web Audio Biquad Filter Nodes and can be
 * instantiated with 3 or 8 bands. Bands can be added or removed from
 * the EQ by directly modifying window.p5.EQ.bands (the array that stores filters).
 *
 * This class extends <a href = "/reference/#/window.p5.Effect">window.p5.Effect</a>.
 * Methods <a href = "/reference/#/window.p5.Effect/amp">amp()</a>, <a href = "/reference/#/window.p5.Effect/chain">chain()</a>,
 * <a href = "/reference/#/window.p5.Effect/drywet">drywet()</a>, <a href = "/reference/#/window.p5.Effect/connect">connect()</a>, and
 ...
 * @return {Object} window.p5.EQ object
 *
 * @example
 * <div><code>
 * let eq, soundFile
 ...
 *
 *   eq = new window.p5.EQ(eqBandNames.length);
...
function (_Effect) {
  ...
  function EQ(_eqsize) {
    ...
    _this = eq_possibleConstructorReturn(this, eq_getPrototypeOf(EQ).call(this)); //window.p5.EQ can be of size (3) or (8), defaults to 3

    _eqsize = _eqsize === 3 || _eqsize === 8 ? _eqsize : 3;
    var factor;
    _eqsize === 3 ? factor = Math.pow(2, 3) : factor = 2;
    /**
     *  The window.p5.EQ is built with abstracted window.p5.Filter objects.
     *  To modify any bands, use methods of the <a
     *  href="/reference/#/window.p5.Filter" title="window.p5.Filter reference">
     *  window.p5.Filter</a> API, especially `gain` and `freq`.
  ...
  eq_createClass(EQ, [{
    ...
    /**
     * Add a new band. Creates a window.p5.Filter and strips away everything but
     * the raw biquad filter. This method returns an abstracted window.p5.Filter,
     * which can be added to window.p5.EQ.bands, in order to create new EQ bands.
     * @private
     * @for window.p5.EQ
     * @method  _newBand
     * @param  {Number} freq
...
//   *
//   * <code>window.p5.Panner3D</code> - Constructs a Spatial Panner<br/>
//   * <code>window.p5.Listener3D</code> - Constructs a Spatial Listener<br/>
//   *
//   * @class listener
//   * @constructor
//   * @return {Object} window.p5.Listener3D Object
//   *
 ...
 * by <code>window.p5.soundOut.audiocontext.listener</code>
 *
 *
 * @class window.p5.Panner3D
 * @constructor
 */
 ...
 *  and outputs a delayed version of that sound. The window.p5.Delay can
 ...
 *
 *    osc = new window.p5.Oscillator('square');
 *    osc.amp(0.5);
 *    delay = new window.p5.Delay();
 *
...
function (_Effect) {
  ...
  function Delay() {
    ...
    /**
     *  The window.p5.Delay is built with two
  ...
  delay_createClass(Delay, [{
     ...
     *                              cutoff, or an object (i.e. a window.p5.Oscillator)
    ...
    } // DocBlocks for methods inherited from window.p5.Effect
    ...
    /**
     *  Send output to a window.p5.sound or web audio object
     *
     *  @method  connect
     *  @for window.p5.Delay
     *  @param  {Object} unit
 ...
 *  physical space. The window.p5.Reverb has paramters for Time (how long does the
 *  reverb last) and decayRate (how much the sound decays with each echo)
 *  that can be set with the .set() or .process() methods. The window.p5.Convolver
 *  extends window.p5.Reverb allowing you to recreate the sound of actual physical
...
function (_Effect) {
  ...
  reverb_createClass(Reverb, [{
     ...
     *
     *  @method  process
     *  @for window.p5.Reverb
     *  @param  {Object} src     window.p5.sound / Web Audio object with a sound
     *                           output.
...
/**
 *  <p>window.p5.Convolver extends window.p5.Reverb. It can emulate the sound of real
 ...
 *  window.p5.Convolver with a path to your impulse response audio file.</p>
 *
 *  @class window.p5.Convolver
 *  @extends window.p5.Effect
 *  @constructor
...
function (_Reverb) {
  ...
  function Convolver(path, callback, errorCallback) {
    ...
    /**
     *  Internally, the window.p5.Convolver uses the a
  ...
  reverb_createClass(Convolver, [{
    ...
    value: function _loadBuffer(_path, callback, errorCallback) {
      var path = window.p5.prototype._checkFileFormats(_path);
    ...
    /**
     *  Load and assign a new Impulse Response to the window.p5.Convolver.
     ...
     *  to a window.p5.Convolver, then you can use this method to toggle between
...
/**
 *  Create a window.p5.Convolver. Accepts a path to a soundfile
...
function () {
  function Metro() {
    ...
    this.syncedParts = [];
    this.bpm = 120; // gets overridden by window.p5.Part
 ...
 *  window.p5.Parts. This method will impact all active window.p5.Parts.
 *
 *  @method setBPM
 *  @for p5
...
window.p5.prototype.setBPM = function (bpm, rampTime) {
  BPM = bpm;
 ...
 *
 *  <p>Phrases must be added to a window.p5.Part for playback, and
 ...
 *    textAlign(CENTER, CENTER);
 *
 *    myPhrase = new window.p5.Phrase('bbox', onEachStep, pattern);
 *    myPart = new window.p5.Part();
...
/**
 *  <p>A window.p5.Part plays back one or more window.p5.Phrases. Instantiate a part
 *  with steps and tatums. By default, each step represents a 1/16th note.</p>
 *
 *  <p>See window.p5.Phrase for more about musical timing.</p>
 *
 *  @class window.p5.Part
 *  @constructor
 ...
 *    text('tap to play', width/2, height/2);
 *
 *    let boxPhrase = new window.p5.Phrase('box', playBox, boxPat);
 *    let drumPhrase = new window.p5.Phrase('drum', playDrum, drumPat);
 *    myPart = new window.p5.Part();
...
function () {
  ...
  looper_createClass(Part, [{
    ...
    /**
     *  Add a window.p5.Phrase to this Part.
     *
     *  @method  addPhrase
     *  @for window.p5.Part
     *  @param {window.p5.Phrase}   phrase   Reference to a window.p5.Phrase
     */
    ...
    value: function addPhrase(name, callback, array) {
      ...
      if (arguments.length === 3) {
        ...
        throw 'invalid input. addPhrase accepts name, callback, array or a window.p5.Phrase';
      }
 ...
 *  <code>new window.p5.Score(a, a, b, a, c)</code>
 *
 *  @class window.p5.Score
 *  @constructor
 *  @param {window.p5.Part} [...parts] One or multiple parts, to be played in sequence.
 */
 ...
 *    soundLoop = new window.p5.SoundLoop(onSoundLoop, intervalInSeconds);
 *
 *    synth = new window.p5.MonoSynth();
 * }
 *
 * function canvasPressed() {
...
function () {
  ...
  soundLoop_createClass(SoundLoop, [{
     ...
     * @method  syncedStart
     * @for window.p5.SoundLoop
     * @param  {Object} otherLoop   A window.p5.SoundLoop to sync with
...
function (_Effect) {
  ...
  function Compressor() {
    ...
    /**
     *
     * The window.p5.Compressor is built with a <a href="https://www.w3.org/TR/webaudio/#the-dynamicscompressornode-interface"
...
/**
 *  <p>PeakDetect works in conjunction with window.p5.FFT to
 *  look for onsets in some or all of the frequency spectrum.
 *  </p>
 *  <p>
 *  To use window.p5.PeakDetect, call <code>update</code> in the draw loop
 *  and pass in a window.p5.FFT object.
 *  </p>
 *  <p>
 ...
 *    textAlign(CENTER);
 *
 *    // window.p5.PeakDetect requires a window.p5.FFT
 *    fft = new window.p5.FFT();
 *    peakDetect = new window.p5.PeakDetect();
 *  }
 *
 *  function draw() {
 *    background(0);
...
function () {
   ...
   *
   *  @method  update
   *  @param  {window.p5.FFT} fftObject A window.p5.FFT object
   */
 ...
 *  The window.p5.SoundRecorder records all sound output from your sketch,
 *  or can be assigned a specific source with setInput().</p>
 *  <p>The record() method accepts a window.p5.SoundFile as a parameter.
 *  When playback is stopped (either after the given amount of time,
 *  or with the stop() method), the window.p5.SoundRecorder will send its
 *  recording to that window.p5.SoundFile for playback.</p>
 *
 *  @class window.p5.SoundRecorder
 *  @constructor
 *  @example
 *  <div><code>
 ...
 *
 *      // record to our window.p5.SoundFile
...
function () {
  function SoundRecorder() {
    ...
    this._workletNode.connect(window.p5.soundOut._silentNode);

    this.setInput(); // add this window.p5.SoundFile to the soundArray

    main.soundArray.push(this);
  }
  /**
   *  Connect a specific device to the window.p5.SoundRecorder.
   *  If no parameter is given, window.p5.SoundRecorer will record
   *  all audible window.p5.sound from your sketch.
   *
   *  @method  setInput
   *  @for window.p5.SoundRecorder
   *  @param {Object} [unit] window.p5.sound object or a web audio unit
   *                         that outputs sound
   */
  ...
  soundRecorder_createClass(SoundRecorder, [{
    ...
    value: function setInput(unit) {
      ...
      if (unit) {
        ...
        window.p5.soundOut.output.connect(this.input);
      }
    }
    /**
     *  Start recording. To access the recording, provide
     *  a window.p5.SoundFile as the first parameter. The window.p5.SoundRecorder
     *  will send its recording to that window.p5.SoundFile for playback once
     *  recording is complete. Optional parameters include duration
     *  (in seconds) of the recording, and a callback function that
     *  will be called once the complete recording has been
     *  transfered to the window.p5.SoundFile.
     *
     *  @method  record
     *  @for window.p5.SoundRecorder
     *  @param  {window.p5.SoundFile}   soundFile    window.p5.SoundFile
     ...
     *  the results will be sent to the window.p5.SoundFile that
...
function (_Effect) {
  ...
  function Distortion(amount, oversample) {
    ...
    var curveAmount = window.p5.prototype.map(amount, 0.0, 1.0, 0, 2000);
    /**
     *  The window.p5.Distortion is built with a
 ...
 *    mixGain = new window.p5.Gain();
 *    mixGain.connect();
 *    sound1.disconnect(); // diconnect from p5 output
 *    sound1Gain = new window.p5.Gain(); // setup a gain node
 ...
 * remain compatible with window.p5.PolySynth();
 *
 * @class window.p5.AudioVoice
 * @constructor
 */
 ...
 *    text('tap to play', width/2, height/2);
 *
 *    monoSynth = new window.p5.MonoSynth();
 *  }
 *
 *  function playSynth() {
 *    userStartAudio();
...
function (_AudioVoice) {
  ...
  function MonoSynth() {
    ...
    _this.setADSR(0.02, 0.25, 0.05, 0.35); // oscillator --> env --> this.output (gain) --> window.p5.soundOut
 ...
 *
 *  @class window.p5.PolySynth
 *  @constructor
 *
 *  @param {Number} [synthVoice]   A monophonic synth voice inheriting
 *                                 the AudioVoice class. Defaults to window.p5.MonoSynth
 ...
 *
 *    polySynth = new window.p5.PolySynth();
 *  }
 *
 *  function playSynth() {
 *    userStartAudio();
...
function () {
  function PolySynth(audioVoice, maxVoices) {
     ...
     * window.p5.PolySynth defaults to using the window.p5.MonoSynth as its voice.
     * @property AudioVoice
     */

    this.AudioVoice = audioVoice === undefined ? window.p5.MonoSynth : audioVoice;
    /**
  ...
  polysynth_createClass(PolySynth, [{
     ...
     *  @example
     *  <div><code>
     *  let polySynth = new window.p5.PolySynth();
     *  let pitches = ['G', 'D', 'G', 'C'];
     *  let octaves = [2, 3, 4];
     *
     *  function setup() {
...
var Signal_Signal = function Signal() {
  ...
  console.warn('window.p5.Signal is deprecated , Use Tone.js Signal instead ');
};
...
window.p5.prototype.getAudioContext = audiocontext["b" /* getAudioContext */];
window.p5.prototype.userStartAudio = audiocontext["c" /* userStartAudio */];


window.p5.prototype.sampleRate = sampleRate;
window.p5.prototype.freqToMidi = freqToMidi;
window.p5.prototype.midiToFreq = midiToFreq;
window.p5.prototype.noteToFreq = noteToFreq;
window.p5.prototype.soundFormats = soundFormats;
window.p5.prototype.disposeSound = disposeSound;
window.p5.prototype._checkFileFormats = _checkFileFormats;
window.p5.prototype._mathChain = _mathChain;
window.p5.prototype.convertToWav = convertToWav;
window.p5.prototype.interleave = interleave;
window.p5.prototype.writeUTFBytes = writeUTFBytes;
window.p5.prototype.safeBufferSize = safeBufferSize;
window.p5.prototype.saveSound = saveSound; // register removeSound to dispose of p5sound SoundFiles, Convolvers,
// Oscillators etc when sketch ends

window.p5.prototype.registerMethod('remove', window.p5.prototype.disposeSound);



window.p5.Panner = panner_0;

window.p5.SoundFile = soundfile;
window.p5.prototype.loadSound = loadSound; // register preload handling of loadSound

window.p5.prototype.registerPreloadMethod('loadSound', window.p5.prototype);

window.p5.Amplitude = amplitude;

window.p5.FFT = fft;

window.p5.Oscillator = oscillator;
window.p5.SinOsc = SinOsc;
window.p5.TriOsc = TriOsc;
window.p5.SawOsc = SawOsc;
window.p5.SqrOsc = SqrOsc;


window.p5.Noise = noise;

window.p5.Pulse = pulse;

window.p5.AudioIn = audioin;

window.p5.Effect = effect;

window.p5.Filter = filter;
window.p5.LowPass = LowPass;
window.p5.HighPass = HighPass;
window.p5.BandPass = BandPass;

window.p5.EQ = eq;

window.p5.listener3D = listener3d;

window.p5.Panner3D = panner3d;

window.p5.Delay = delay;

window.p5.Reverb = Reverb;
window.p5.Convolver = reverb_Convolver;
window.p5.prototype.createConvolver = createConvolver;
window.p5.prototype.registerPreloadMethod('createConvolver', window.p5.prototype);

window.p5.Metro = metro;

window.p5.Phrase = Phrase;
window.p5.Part = looper_Part;
window.p5.Score = Score;

window.p5.SoundLoop = soundLoop;

window.p5.Compressor = compressor;

window.p5.peakDetect = peakDetect;

window.p5.SoundRecorder = soundRecorder;

window.p5.Distortion = distortion;

window.p5.Gain = gain;

window.p5.AudioVoice = audioVoice_0;

window.p5.MonoSynth = monosynth;

window.p5.OnsetDetect = onsetDetect;

window.p5.PolySynth = polysynth;

window.p5.PeakDetect = peakDetect; // Following are the deprecated classes


window.p5.Signal = deprecations_Signal;

/***/ })
/******/ ]);
//# sourceMappingURL=window.p5.sound.js.map 